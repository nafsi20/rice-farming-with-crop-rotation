...
# Introduction
  ...
  Crop rotation is the practice of planting different crops sequentially ( @lubridate2011) on the same plot of land to improve soil health, optimize nutrients in the soil, and combat pest and weed pressure.
...
knitr::write_bib(c(.packages(),
                   'knitr','decisionSupport'), 'References/reference.bib')
```
