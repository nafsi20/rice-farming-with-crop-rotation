...
<center>
```{r echo=FALSE}
knitr::include_graphics('overview of the project.png')
```
</center>
...
```{r echo=FALSE}
knitr::include_graphics('conceptual model.png')
```
...
<center>
```{r echo=FALSE}
knitr::include_graphics('Variable estimate.png')
```
</center>
...
```{r echo=FALSE}
knitr::include_graphics('Estimate calculation.png')
```
